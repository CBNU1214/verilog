...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL_TX}]; #IO_0_15 Sch=ja[1]
...
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL_RX }]; #IO_L6P_T0_15 Sch=ja[4]
...
#set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { clk_rst }]; #IO_L16P_T2_35 Sch=ck_rst
